...
export function AlbumPage() {
  ...
  const [album, setAlbum] = useState<(SubsonicAlbum & { song: any[] }) | null>(
    null,
  );
                ...
                return (
                  <tr
                    ...
                    className={`transition-all duration-200 cursor-pointer group ${
                      isSelected ? "bg-violet-500/10" : "hover:bg-zinc-900/50"
                    }`}
                          ...
                          {openMenuId === song.id && (
                            ...
                            >
                              <div className="py-1">
                                ...
                                >
                                  <Heart
                                    className={`w-3 h-3 ${likedSongs.has(song.id) ? "fill-current text-red-500" : ""}`}
                                  />
                                  <span>
                                    {likedSongs.has(song.id)
