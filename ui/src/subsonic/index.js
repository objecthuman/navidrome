...
const nowPlaying = (id, position = null, pageType = null) =>
  scrobble(id, null, false, position, pageType)
...
const search3 = (query, artistCount = 10, albumCount = 20, songCount = 50) => {
  return httpClient(
    url('search3.view', null, {
      query,
      artistCount,
      artistOffset: 0,
      albumCount,
