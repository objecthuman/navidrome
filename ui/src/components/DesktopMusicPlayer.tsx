...
export function DesktopMusicPlayer({
  ...
  return (
    <div
      className={`hidden md:block fixed bottom-0 left-0 right-0 bg-zinc-900/95 backdrop-blur-md border-t border-zinc-800
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <button
                className="p-2 hover:bg-zinc-800 rounded-full transition-colors text-zinc-400 cursor-pointer"
              ...
              <button
                ...
                className="p-4 bg-violet-500 hover:bg-violet-600 rounded-full transition-colors cursor-pointer"
      ...
      {!isExpanded && (
        <div className="relative flex items-center px-4 py-3 h-20">
          ...
          <div className="flex items-center gap-3 flex-shrink-0 z-10">
            {/* Cover Art */}
            <div
              className="w-14 h-14 rounded-lg overflow-hidden bg-zinc-800 shadow-lg cursor-pointer"
              onClick={onCollapse}
            >
              <img
                src={`https://picsum.photos/seed/${currentSong.id}/300/300`}
